...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--directory", help="App directory name", required=True
    )
    parser.add_argument(
        "-r", "--rules", nargs="+", help="rules numbers", required=True
    )
    parser.add_argument(
        "-f",
        "--flowdroid",
    ...
    parser.add_argument(
        ...
        "--validation",
        action="store_true",
        help="Open files to view the Code",
    )
    ...
    for r in args.rules:
        ...
        rulefct = func[int(r) - 1](
            directory + "/rule" + str(r) + "/",
            True,
            False,
            None,
            args.flowdroid,
