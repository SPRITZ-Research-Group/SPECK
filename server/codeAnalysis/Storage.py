...
class Storage():
	...
	def displayGlobalStats(self):
		...
		for app in self.apps:
			print("[+] %s" % app[Storage.APPNAME])
			for elem in app[Storage.RESULTS]:
				if Storage.TYPE in elem:
					if elem[Storage.TYPE] == Storage.CRITICAL:
						print("\033[31m(%d) %d %s\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.MSG]))
					elif elem[Storage.TYPE] == Storage.WARNING:
						print("\033[33m(%d) %d %s\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.MSG]))
					elif elem[Storage.TYPE] == Storage.INFO:
						print("\033[32m(%d) %d %s\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.MSG]))


					elif elem[Storage.TYPE] == Storage.INT_CRITICAL:
						print("\033[31m[INTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))
					elif elem[Storage.TYPE] == Storage.INT_WARNING:
						print("\033[33m[INTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))
					elif elem[Storage.TYPE] == Storage.INT_INFO:
						print("\033[32m[INTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))


					elif elem[Storage.TYPE] == Storage.EXT_CRITICAL:
						print("\033[31m[EXTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))
					elif elem[Storage.TYPE] == Storage.EXT_WARNING:
						print("\033[33m[EXTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))
					elif elem[Storage.TYPE] == Storage.EXT_INFO:
						print("\033[32m[EXTERNAL] (%d) %d/%d\033[0m" % (elem[Storage.ID], elem[Storage.NB], elem[Storage.TOT]))


					elif elem[Storage.TYPE] == Storage.NOTHING:
						print("\033[32m(%d) %s\033[0m" % (elem[Storage.ID], elem[Storage.MSG]))
	...
	def displaySyntheticStats(self, ruleNb):
		...
		for app in self.apps:
			...
			print("%s %s %d %s %d %s %d %s %d %s %d %s %d" % (app[Storage.APPNAME], keys[0], res[0], keys[1], res[1], keys[2], res[2], keys[3], res[3], keys[4], res[4], keys[5], res[5]))
